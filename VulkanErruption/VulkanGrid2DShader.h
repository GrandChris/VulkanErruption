...
inline auto Grid2DShader::getVertexAttributeDescriptions()
{
	...
	attributeDescriptions[0].setOffset(offsetof(VertexBufferElement, height1));

	attributeDescriptions[1].setBinding(0);
	attributeDescriptions[1].setLocation(1);
	attributeDescriptions[1].setFormat(vk::Format::eR32Sfloat);
	attributeDescriptions[1].setOffset(offsetof(VertexBufferElement, height2));

	attributeDescriptions[2].setBinding(0);
	attributeDescriptions[2].setLocation(2);
	attributeDescriptions[2].setFormat(vk::Format::eR32Sfloat);
	attributeDescriptions[2].setOffset(offsetof(VertexBufferElement, height3));
	...
	attributeDescriptions[3].setOffset(offsetof(VertexBufferElement, height4));
