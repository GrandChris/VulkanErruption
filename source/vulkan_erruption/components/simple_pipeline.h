...
inline vk::PipelineLayout const & SimpleGraphicsPipeline::getPipelineLayout() const
{
    return pipelineLayout.get();
}   

inline vk::Pipeline const & SimpleGraphicsPipeline::getPipeline() const
{
    return graphicsPipeline.get();
}

inline void SimpleGraphicsPipeline::clear() 
{
