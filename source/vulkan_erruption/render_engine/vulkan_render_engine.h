...
class VulkanRenderEngine : public ParticleRenderer {
public:
	// C-Tor
	VulkanRenderEngine(bool enableValidationLayer);
...
template<typename T>
inline void VulkanRenderEngine::createVertexBuffer(
	vk::UniqueDeviceMemory& vertexBufferMemory, vk::UniqueBuffer& vertexBuffer, 
	std::vector<T> const& vertices)
{
...
template<typename T>
inline void VulkanRenderEngine::updateUniformBuffer(std::vector<vk::UniqueDeviceMemory> const& uniformBuffersMemory, 
	T const& uniformBufferObject)
{
...
template<typename T>
inline void VulkanRenderEngine::updateVertexBuffer(vk::UniqueDeviceMemory const & vertexBufferMemory,
	std::vector<T> const& vertices)
{
...
template<typename T>
inline void VulkanRenderEngine::updateVertexBuffer(std::vector<vk::UniqueDeviceMemory> const& vertexBufferMemory, 
	std::vector<T> const& vertices)
{
